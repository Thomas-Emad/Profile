                ...
                <div class="projects grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] justify-center gap-4">
                    @foreach ($projects as $project)
                        <div data-drawer-target="show-project" data-drawer-show="show-project"
                            ...
                            <img src="{{ url('laravel/storage/app/public/projects/' . $project->attachments()->where('banner', true)->first()->attachment) }}"
                                class="w-screen h-full" alt="{{ $project->title }}" onerror=''>
                            <div
                            ...
                            ${
                              response.attachments.map(image => {
                                return `
                                            <!-- Item -->
                                            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                                <img src="{{ url('laravel/storage/app/public/projects/${image.attachment}') }}"
